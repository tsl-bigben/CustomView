...
public final class SmartTabLayout extends HorizontalScrollView {
    ...
    private static final boolean TAB_SHOW_NUM = true;
    ...
    private boolean distributeEvenly = DEFAULT_DISTRIBUTE_EVENLY;
    private final DisplayMetrics dm = getResources().getDisplayMetrics();
    private final float density = dm.density;

    private int tabBackgroundResId = NO_ID;
    private boolean textAllCaps = TAB_VIEW_TEXT_ALL_CAPS;
    private ColorStateList textColors;
    private float textSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, TAB_VIEW_TEXT_SIZE_SP, dm);
    private int textHorizontalPadding = (int) (TAB_VIEW_PADDING_DIPS * density);
    private int textMinWidth = (int) (TAB_VIEW_TEXT_MIN_WIDTH * density);
    private int customTabLayoutId = NO_ID;
    private int customTabTextViewId = NO_ID;
    private int customNumTextViewId = NO_ID;
    private boolean clickable = TAB_CLICKABLE;
    private boolean shoNum = TAB_SHOW_NUM;
    private int titleOffset = (int) (TITLE_OFFSET_DIPS * density);
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        customNumTextViewId = a.getResourceId(R.styleable.stl_SmartTabLayout_stl_customNumTextViewId, customNumTextViewId);
        ...
        shoNum = a.getBoolean(R.styleable.stl_SmartTabLayout_stl_showNum, shoNum);
        ...
        /*if (customTabLayoutId != NO_ID) {
            setCustomTabView(customTabLayoutId);
        }*/
     ...
     */
    public void setViewPager(ViewPager viewPager, TabProvider tabProvider) {
    ...
    /*public void setNum(int position, int num) {
        ...
        if (view != null) {
            View v = view.findViewById(customNumTextViewId);
            if (v instanceof TextView) {
                TextView numTextView = (TextView) v;
                numTextView.setText(String.valueOf(num));
                numTextView.setVisibility(VISIBLE);
            }
        }
    }*/
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == viewPager.getCurrentItem()) {
                if(tabProvider != null) {
                    tabProvider.selectedTab(tabView, true);
                } else{
    ...
    public interface TabProvider {
        ...
        void selectedTab(View view, boolean flag);
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            int size = tabStrip.getChildCount();
            for (int i = 0; i < size; i++) {
                if(tabProvider != null){
                    tabProvider.selectedTab(tabStrip.getChildAt(i), position == i);
                } else {
